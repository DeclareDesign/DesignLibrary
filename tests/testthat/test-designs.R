...
test_that("Mediation works", {
  ...
  vary_N_mediation <- expand_design(template = mediation_template, rho = seq(-1,1,.2))
...
test_that("Two-Way Factorial works", {
  ...
  vary_N_2way <- expand_design(template = two_way_factorial_template, N = c(100,200,300))
...
test_that("Regression Discontinuity works", {
  ...
  vary_N_RD <-
    expand_design(template = regression_discontinuity_template, N = c(100, 200, 300))
...
test_that("Two Arm works", {
  ...
  vary_N_two_arm <-
    expand_design(template = two_arm_template, N = c(200, 300, 400))
...
test_that("Randomized Response works", {
  ...
  vary_N_randomized_response <-
    expand_design(template = randomized_response_template, N = c(200, 300, 400))
...
test_that("Noncompliance works", {
  ...
  vary_N_noncompliance <- expand_design(template = noncompliance_template, N = c(200, 300, 400))
...
test_that("List Experiment works", {
  ...
  vary_N_list_experiment <- expand_design(template = list_experiment_template, N = c(200, 300, 400))
...
test_that("Matching works", {
  ...
  vary_N_matching <- expand_design(template = matching_template, N = c(200, 300, 400))
...
test_that("Process Tracing works",{
  ...
  vary_N_process_tracing <-
    expand_design(template = process_tracing_template, N = c(200, 300, 400))
...
test_that("Election Forecast works", {
  ...
  vary_N_election_forecast <- expand_design(template = election_forecast_template, N = c(200, 300, 400))
...
test_that("SRS works", {
  ...
  vary_N_srs <- expand_design(template = srs_template, n = c(200, 300, 400))
...
test_that("Audit works", {
  ...
  vary_N_audit <-
    expand_design(template = audit_template, N = c(200, 300, 400))
...
test_that("Crossover works", {
  ...
  vary_rho_crossover <-
    expand_design(template = crossover_template, rho = seq(.1,.9,.1))
...
test_that("Blocked and Clustered works", {
  ...
  vary_icc_blocked_and_clustered <-
    expand_design(template = blocked_and_clustered_template, cluster_icc = seq(.1,.5,.1))
