...
#' 
#' Key limitations: The designer assumes constant treatment effects and no covariance between potential outcomes.
#' 
#' @param N_blocks An integer. Number of blocks.
#' @param N_clusters_in_block An integer. Number of clusters in each block.
#' @param N_i_in_cluster An integer. Individuals per cluster.
#' @param sd_block A number. Standard deviation of block level shocks.
#' @param sd_cluster A number. Standard deviation of cluster level shock.
#' @param sd_i_0 A number. Standard deviation of individual level shock in control.
#' @param sd_i_1 A number. Standard deviation of individual level shock in treatment.
#' @param prob A number in [0,1]. Treatment assignment probability.
#' @param control_mean A number. Average outcome in control.
#' @param ate A number. Average treatment effect. Alternative to specifying \code{treatment_mean}.
#' @param treatment_mean A number. Average outcome in treatment. Overrides \code{ate} if both specified.
#' @param rho A number in [0,1]. Correlation in individual shock between potential outcomes for treatment and control.
