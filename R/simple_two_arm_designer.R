...
simple_two_arm_designer <- function(N = 100,
  ...
  if(treatment_mean != ate + control_sd) warning("`treatment_mean` is not consistent with `ate`+`control_mean`. Value provided in `treatment_mean` will override `ate` value.")
