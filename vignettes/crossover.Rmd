...
In R, you can generate a crossover design using the template function `crossover_designer()` in the `DesignLibrary` package by running the following lines, which load the package:
