...
Let us consider a specific type of randomized response design in which respondents are asked to use a randomization device, such as a die, whose outcome is unobserved to the enumerator. Respondents are then asked to answer "Yes" if the die shows numbers "1", "2", "3", or "4" and to answer truthfully if the die shows "5", or "6." This is aimed at increasing the privacy of respondents and elliciting truthful responses.
