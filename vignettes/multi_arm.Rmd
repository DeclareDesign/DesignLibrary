...
- **I**nquiry:  We are interested in all of the pairwise comparisons between arms: $E[Y(m) - Y(m')]$, for all $m \in \{1,...,M\}$.  

- **D**ata strategy: We randomly assign $k/N$ units to each of the treatment arms.

- **A**nswer strategy: We take every pairwise difference in means corresponding to the specific estimand.
...
- We see that a design like this 

- The pairwise differences in means provide unbiased estimates of  the average treatment effect (ATE) in each arm. These estimates, however, are not so precise;  The estimated standard deviation is large yielding wide confidence intervals that contain the true value of the ATEs more than 95\% of the time.

## Exercises

- Use the designer to declare four designs. Each should only have one arm that has an effect, 
