...
- **M**odel:  We specify a population of `N`  units partitioned into `N\_blocks` (regions, say). Each block has `N\_clusters\_in\_block` clusters (cities, say) and within each cluster there are `N\_in\_cluster` individuals.  The variance of an individual's outcomes has three components: the block's variance, the cluster's variance and the subject's variance. 
