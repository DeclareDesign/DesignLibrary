...
Let us diagnose our design when the cluster variance is subtantively larger than the block one.

```{r,eval = TRUE}
diagnosis <- diagnose_design(block_cluster_two_arm_designer(N_blocks = 4, N_clusters_in_block = 4, N_i_in_cluster = 5, sd_cluster = 2))
