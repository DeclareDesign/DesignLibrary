...
- **M**odel:  We specify a population of `N`  units partitioned into `N_blocks` (regions, say). Each block has `N_clusters_in_block` clusters (cities, say) and within each cluster there are `N_in_cluster` individuals.  The variance of an individual's outcomes has three components: the block's variance, the cluster's variance and the subject's variance. 
