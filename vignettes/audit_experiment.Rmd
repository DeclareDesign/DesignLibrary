...
kable(get_diagnosands(diagnosis)[,
                                 c("estimand_label", "mean_estimand",
                                   "mean_estimate",
                                   "se(mean_estimate)", "bias", "se(bias)")],
      col.names = c("Estimand Label", "Mean Estimand",
