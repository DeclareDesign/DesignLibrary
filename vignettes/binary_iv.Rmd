...
* **I**nquiry:
   ...
   *  Fourth, when monotonicity does not hold, but independence and exclusion restriction do, we define the estimand as a linear combination of treatment effects for compliers and defiers: $LATE_{het} = \frac{\Pr(C)}{\Pr(C) - \Pr(D)}E[Y_i(1)-Y_i(0)| D] - \frac{\Pr(D)}{\Pr(C) - \Pr(D)}E[Y_i(1)-Y_i(0)| D]$, where $C$ and $D$ indicate compliers and defiers, respectively [see @imbens2014instrumental: 34].
