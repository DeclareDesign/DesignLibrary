...
We can see that when the error terms of the mediator regression and the outcome regression are not correlated the direct and indirect effects can be estimated without bias.
...
```{r, eval=FALSE}
mediation_analysis_design <- mediation_analysis_designer(N = 500, a = .2, b = .4, d = .2, rho = .15)
```
