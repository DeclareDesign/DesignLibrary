...
In R, you can generate a pre-test post-test design using the template function `pretest_posttest_designer()` in the `DesignLibrary` package by running the following lines, which load the package:
