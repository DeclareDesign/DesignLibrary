...
```{r args, code=template_default_args_text(two_way_factorial_template)}
```

```{r body, code=template_text(two_way_factorial_template)}
```
...
```{r two_way_factorial_diagnoses_N}
