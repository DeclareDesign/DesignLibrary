...
For an example of how to write such a vignette, see [the example design entry](https://declaredesign.org/library/articles/example_design.html). 
...
Very often, more complicated designs will rely on external data. If your design requires external data to run, please make sure that it is sourced into your vignette through a publicly accessible URL. Our [example design entry](https://declaredesign.org/library/articles/example_design.html) gives one example of how you might read in data from an external website. We will not accept any objects in a pull request aside from an `.Rmd` file.
